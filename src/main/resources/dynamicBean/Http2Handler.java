...
//@Component("httpHandler2")
@ChannelHandler.Sharable
public class Http2Handler extends SimpleChannelInboundHandler<FullHttpRequest> implements DynamicHandler {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        count++;
        logger.info("http2 connect " + count);
